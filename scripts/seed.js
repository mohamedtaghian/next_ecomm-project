...
const BRANDS = [
  ...
  {
    name: "Nestlé",
    image: "https://upload.wikimedia.org/wikipedia/en/c/c8/Nestl%C3%A9.svg",
  },
  {
    name: "Danone",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/0/0c/Danone_logo.svg",
  },
  {
    name: "Pepsico",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/0/04/PepsiCo_logo.svg",
  },
];
  ...
  const PRODUCTS = [
    {
      title: "iPhone 15 Pro",
      description:
        "The latest Apple iPhone with titanium design and A17 Pro chip. Stunning 48MP camera system.",
      price: 45000,
      quantity: 50,
      imageCover:
        "https://images.unsplash.com/photo-1696446701796-da61c6a2b7d4?w=500",
      images: [
        "https://images.unsplash.com/photo-1696446701796-da61c6a2b7d4?w=500",
      ],
      categoryIdx: 0,
    ...
    },
    {
      ...
      description:
        "Samsung flagship phone with Galaxy AI and pro-grade camera. 200MP main sensor.",
      price: 38000,
    ...
    },
    {
      ...
      description:
        "Fresh organic apples sourced from local farms. Rich in vitamins and antioxidants.",
      price: 45,
      quantity: 200,
      imageCover:
    ...
    },
    {
      ...
      description:
        "Sweet and juicy strawberries picked at peak ripeness. Perfect for smoothies and desserts.",
      price: 60,
    ...
    {
      title: "Full Fat Milk (1L)",
      description:
        "Fresh pasteurised full-fat cow's milk. Rich in calcium and vitamins.",
      price: 28,
      quantity: 300,
      imageCover:
    ...
    },
    {
      ...
      description:
        "Farm-fresh free-range eggs. Hens raised with space to roam on natural feed.",
      price: 75,
      quantity: 150,
      imageCover:
    ...
    },
    {
      ...
      description:
        "Traditional sourdough bread baked fresh daily. Crispy crust with a soft, chewy interior.",
      price: 55,
      quantity: 80,
      imageCover:
    ...
    {
      title: "Croissants (4pk)",
      description:
        "Buttery, flaky French-style croissants baked fresh every morning. Perfect with jam.",
      price: 40,
    ...
    {
      title: "Pepsi 500ml (6pk)",
      description:
        "Classic Pepsi cola pack of 6 bottles. Refreshing and ice-cold taste.",
      price: 80,
      quantity: 500,
      imageCover:
    ...
    {
      title: "Nestlé Pure Life Water (12pk)",
      description:
        "Pure, clean drinking water. 12×500ml bottles, perfect for home and office.",
      price: 45,
      quantity: 400,
      imageCover:
    ...
    },
    {
      ...
      description:
        "Premium mix of cashews, almonds, walnuts and pistachios. Lightly salted and roasted.",
      price: 120,
      quantity: 120,
      imageCover:
    ...
    },
    {
      ...
      description:
        "Rich 70% dark chocolate with hints of vanilla. Ethically sourced cocoa.",
      price: 65,
